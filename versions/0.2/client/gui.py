...
class Gui:
    ...
    def __init__(self):
        ...
        # Piles
        self.deck = cardpile.CardPile(self.game_frame, self.settings)
        self.gamepile = cardpile.CardPile(self.game_frame, self.settings)
    ...
    def draw_window(self):
        ...
        # Game frame
        offset = int(self.settings["gamepile_offset"])
    ...
    def place_deck(self):
        ...
        w, h = opened_card.calculate_size()
        self.deck.place(x=deck_padx, y=deck_pady, width=w + 3 * offset, height=h + 3 * offset)
        self.deck.config(bg=self.settings["green"])
    ...
    def place_gamepile(self):
        ...
        w,h = opened_card.calculate_size()
        self.gamepile.place(x=padx, y=pady, width=w+3*offset, height=h+3*offset)
        self.gamepile.config(bg=self.settings["green"])
    ...
    def place_opponents(self):
        ...
        print(w)
        self.opponents_frame.place(x=0, y=0, width=self.main_frame.winfo_width(), height=height)
