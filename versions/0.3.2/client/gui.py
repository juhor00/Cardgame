...
class Gui:
    ...
    def __init__(self):
        ...
        # Piles
        self.deck = cardpile.CardPile(self.game_frame, self.settings, self.settings["deck_name"])
        self.gamepile = gamepile.GamePile(self.game_frame, self.settings, self.settings["game_name"])
    ...
    def draw_window(self):
        ...
        self.card_frame.config(bg="blue")

        # Game frame
        height = int(self.settings["game_frame_height"])
        ...
        self.game_frame.config(bg="purple")
    ...
    def place_opponents_frame(self):
        ...
        self.opponents_frame.config(bg="pink")
